...
# Basic Requirements
RUN apt-get -y install nginx php5-fpm php5-sqlite php-apc pwgen python-setuptools curl git unzip sqlite3 gettext-base
...
# nginx site conf
ADD ./nginx-site.conf /etc/nginx/conf.d/mysite.template
